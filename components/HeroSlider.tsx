...
const slides = [
  { tag: 'Trusted Physiotherapy — Lalghati Bhopal', staticText: 'Best Physiotherapy\n', typingWords: ['Clinic in Bhopal', 'Centre in Lalghati', 'for Back Pain', 'for Sports Injury'], sub: 'Dr. Pavan Patidar & Dr. Ravina Patidar — advanced care for spine, sports injuries & neuro rehab.', cta: 'Book Consultation', bg: 'from-blue-950 via-slate-900 to-slate-900', accentClass: 'bg-blue-600', textColor: 'text-blue-400', img: 'https://images.unsplash.com/photo-1519824145371-296894a0daa9?auto=format&fit=crop&w=1400&q=80' },
  { tag: 'Sports Injury Rehabilitation', staticText: 'Get Back in the\n', typingWords: ['Game Faster', 'Field Stronger', 'Court Ready'], sub: 'High-performance sports injury recovery using evidence-based physiotherapy protocols.', cta: 'View Sports Rehab', bg: 'from-emerald-950 via-slate-900 to-slate-900', accentClass: 'bg-emerald-500', textColor: 'text-emerald-400', img: 'https://images.unsplash.com/photo-1597452485669-2c7bb5fef90d?auto=format&fit=crop&w=1400&q=80' },
  { tag: 'Neuro Rehabilitation — Stroke & Neuropathy', staticText: 'Regain Strength\n', typingWords: ['After Stroke', 'After Paralysis', 'With Confidence'], sub: 'Expert neuro-physiotherapy by Dr. Ravina Patidar — stroke recovery, peripheral & diabetic neuropathy.', cta: 'Explore Neuro Care', bg: 'from-purple-950 via-slate-900 to-slate-900', accentClass: 'bg-purple-500', textColor: 'text-purple-400', img: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?auto=format&fit=crop&w=1400&q=80' },
  { tag: "Women's Health Physiotherapy", staticText: 'Expert Care for\n', typingWords: ["Women's Health", 'Prenatal Care', 'Postnatal Rehab'], sub: "Specialized physiotherapy for pelvic floor disorders, prenatal & postnatal rehabilitation.", cta: "Book Women's Care", bg: 'from-rose-950 via-slate-900 to-slate-900', accentClass: 'bg-rose-500', textColor: 'text-rose-400', img: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?auto=format&fit=crop&w=1400&q=80' },
