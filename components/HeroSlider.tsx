...
const slides = [
  ...
  { tag: 'Neuro Rehabilitation — Stroke & Neuropathy', staticText: 'Regain Strength\n', typingWords: ['After Stroke', 'After Paralysis', 'With Confidence'], sub: 'Experienced neuro-physiotherapy care by Dr. Pavan Patidar — stroke recovery, peripheral & diabetic neuropathy.', cta: 'Explore Neuro Care', bg: 'from-purple-950 via-slate-900 to-slate-900', accentClass: 'bg-purple-500', textColor: 'text-purple-400', img: '/gallery/clinic8.png' },
